! ROSCO Registry
! This file is automatically generated by write_registry.py using ROSCO v2.10.3
...
Character(*), PARAMETER     :: rosco_version = '2.10.3'             ! ROSCO version
...
TYPE, PUBLIC :: ControlParameters
    ...
    INTEGER(IntKi)                :: SetpointIPC_Mode            ! Setpoint IPC Mode {0 - off, 1 - on}.
    INTEGER(IntKi)                :: SetpointIPC_nHarmonics      ! Number of harmonics used by the setpoint IPC controller. Determines the length of SetpointIPC_Tilt/Yaw_k.
    REAL(DbKi), DIMENSION(:), ALLOCATABLE     :: SetpointIPC_Tilt_k          ! Setpoint IPC tilt amplitudes for different harmonics.
    REAL(DbKi), DIMENSION(:), ALLOCATABLE     :: SetpointIPC_Yaw_k           ! Setpoint IPC yaw amplitudes for different harmonics.
