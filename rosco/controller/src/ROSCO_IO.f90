...
SUBROUTINE WriteRestartFile(LocalVar, CntrPar, ErrVar, objInst, RootName, size_avcOUTNAME)
    ...
    ELSE
        ...
        WRITE( Un, IOSTAT=ErrStat) LocalVar%IPCTip_AxisTilt_1P
        ...
        WRITE( Un, IOSTAT=ErrStat) LocalVar%TipDxcCol_1P
        WRITE( Un, IOSTAT=ErrStat) LocalVar%TipDxcTilt_1P
        WRITE( Un, IOSTAT=ErrStat) LocalVar%TipDxcYaw_1P
        WRITE( Un, IOSTAT=ErrStat) LocalVar%TipDxcColF_1P
        WRITE( Un, IOSTAT=ErrStat) LocalVar%TipDxcTiltF_1P
        WRITE( Un, IOSTAT=ErrStat) LocalVar%TipDxcYawF_1P
        WRITE( Un, IOSTAT=ErrStat) LocalVar%TipDxcTiltRef_1P
...
SUBROUTINE ReadRestartFile(avrSWAP, LocalVar, CntrPar, objInst, PerfData, RootName, size_avcOUTNAME, ErrVar)
    ...
    ELSE
        ...
        READ( Un, IOSTAT=ErrStat) LocalVar%IPCTip_AxisTilt_1P
        ...
        READ( Un, IOSTAT=ErrStat) LocalVar%TipDxcCol_1P
        READ( Un, IOSTAT=ErrStat) LocalVar%TipDxcTilt_1P
        READ( Un, IOSTAT=ErrStat) LocalVar%TipDxcYaw_1P
        READ( Un, IOSTAT=ErrStat) LocalVar%TipDxcColF_1P
        READ( Un, IOSTAT=ErrStat) LocalVar%TipDxcTiltF_1P
        READ( Un, IOSTAT=ErrStat) LocalVar%TipDxcYawF_1P
        READ( Un, IOSTAT=ErrStat) LocalVar%TipDxcTiltRef_1P
...
! Debug routine, defines what gets printed to DEBUG.dbg if LoggingLevel = 1
    ...
    CHARACTER(15), DIMENSION(161)      :: LocalVarOutStrings
    ...
    LocalVarOutData(60) = LocalVar%IPCTip_AxisTilt_1P
    LocalVarOutData(61) = LocalVar%IPC_AxisTilt_1P
    LocalVarOutData(62) = LocalVar%IPC_AxisYaw_1P
    LocalVarOutData(63) = LocalVar%IPC_AxisTilt_2P
    LocalVarOutData(64) = LocalVar%IPC_AxisYaw_2P
    LocalVarOutData(65) = LocalVar%axisTilt_1P
    LocalVarOutData(66) = LocalVar%axisYaw_1P
    LocalVarOutData(67) = LocalVar%axisYawF_1P
    LocalVarOutData(68) = LocalVar%axisTilt_2P
    LocalVarOutData(69) = LocalVar%axisYaw_2P
    LocalVarOutData(70) = LocalVar%axisYawF_2P
    LocalVarOutData(71) = LocalVar%IPC_KI(1)
    LocalVarOutData(72) = LocalVar%IPC_KP(1)
    LocalVarOutData(73) = LocalVar%IPC_IntSat
    LocalVarOutData(74) = LocalVar%PC_State
    LocalVarOutData(75) = LocalVar%PitCom(1)
    LocalVarOutData(76) = LocalVar%PitCom_SD(1)
    LocalVarOutData(77) = LocalVar%PitComAct(1)
    LocalVarOutData(78) = LocalVar%SS_DelOmegaF
    LocalVarOutData(79) = LocalVar%TestType
    LocalVarOutData(80) = LocalVar%Kp_Float
    LocalVarOutData(81) = LocalVar%VS_MaxTq
    LocalVarOutData(82) = LocalVar%VS_LastGenTrq
    LocalVarOutData(83) = LocalVar%VS_LastGenPwr
    LocalVarOutData(84) = LocalVar%VS_MechGenPwr
    LocalVarOutData(85) = LocalVar%VS_SpdErrAr
    LocalVarOutData(86) = LocalVar%VS_SpdErrBr
    LocalVarOutData(87) = LocalVar%VS_SpdErr
    LocalVarOutData(88) = LocalVar%VS_State
    LocalVarOutData(89) = LocalVar%VS_Rgn3Pitch
    LocalVarOutData(90) = LocalVar%WE_Vw
    LocalVarOutData(91) = LocalVar%WE_Vw_F
    LocalVarOutData(92) = LocalVar%WE_VwI
    LocalVarOutData(93) = LocalVar%WE_VwIdot
    LocalVarOutData(94) = LocalVar%WE_Op
    LocalVarOutData(95) = LocalVar%WE_Op_Last
    LocalVarOutData(96) = LocalVar%VS_LastGenTrqF
    LocalVarOutData(97) = LocalVar%PRC_WSE_F
    LocalVarOutData(98) = LocalVar%PRC_R_Speed
    LocalVarOutData(99) = LocalVar%PRC_R_Torque
    LocalVarOutData(100) = LocalVar%PRC_R_Pitch
    LocalVarOutData(101) = LocalVar%PRC_R_Total
    LocalVarOutData(102) = LocalVar%PRC_Min_Pitch
    ...
    LocalVarOutData(137) = LocalVar%TipDxc1
    LocalVarOutData(138) = LocalVar%TipDxc2
    LocalVarOutData(139) = LocalVar%TipDxc3
    LocalVarOutData(140) = LocalVar%TipDxcCol_1P
    LocalVarOutData(141) = LocalVar%TipDxcTilt_1P
    LocalVarOutData(142) = LocalVar%TipDxcYaw_1P
    LocalVarOutData(143) = LocalVar%TipDxcColF_1P
    LocalVarOutData(144) = LocalVar%TipDxcTiltF_1P
    LocalVarOutData(145) = LocalVar%TipDxcYawF_1P
    LocalVarOutData(146) = LocalVar%TipDxcTiltRef_1P
    LocalVarOutData(147) = LocalVar%CC_DesiredL(1)
    LocalVarOutData(148) = LocalVar%CC_ActuatedL(1)
    LocalVarOutData(149) = LocalVar%CC_ActuatedDL(1)
    LocalVarOutData(150) = LocalVar%StC_Input(1)
    LocalVarOutData(151) = LocalVar%Flp_Angle(1)
    LocalVarOutData(152) = LocalVar%RootMyb_Last(1)
    LocalVarOutData(153) = LocalVar%ACC_INFILE_SIZE
    LocalVarOutData(154) = LocalVar%AWC_complexangle(1)
    LocalVarOutData(155) = LocalVar%ZMQ_ID
    LocalVarOutData(156) = LocalVar%ZMQ_YawOffset
    LocalVarOutData(157) = LocalVar%ZMQ_TorqueOffset
    LocalVarOutData(158) = LocalVar%ZMQ_PitOffset(1)
    LocalVarOutData(159) = LocalVar%ZMQ_R_Speed
    LocalVarOutData(160) = LocalVar%ZMQ_R_Torque
    LocalVarOutData(161) = LocalVar%ZMQ_R_Pitch
    ...
    LocalVarOutStrings(60) = 'IPCTip_AxisTilt_1P'
    LocalVarOutStrings(61) = 'IPC_AxisTilt_1P'
    LocalVarOutStrings(62) = 'IPC_AxisYaw_1P'
    LocalVarOutStrings(63) = 'IPC_AxisTilt_2P'
    LocalVarOutStrings(64) = 'IPC_AxisYaw_2P'
    LocalVarOutStrings(65) = 'axisTilt_1P'
    LocalVarOutStrings(66) = 'axisYaw_1P'
    LocalVarOutStrings(67) = 'axisYawF_1P'
    LocalVarOutStrings(68) = 'axisTilt_2P'
    LocalVarOutStrings(69) = 'axisYaw_2P'
    LocalVarOutStrings(70) = 'axisYawF_2P'
    LocalVarOutStrings(71) = 'IPC_KI'
    LocalVarOutStrings(72) = 'IPC_KP'
    LocalVarOutStrings(73) = 'IPC_IntSat'
    LocalVarOutStrings(74) = 'PC_State'
    LocalVarOutStrings(75) = 'PitCom'
    LocalVarOutStrings(76) = 'PitCom_SD'
    LocalVarOutStrings(77) = 'PitComAct'
    LocalVarOutStrings(78) = 'SS_DelOmegaF'
    LocalVarOutStrings(79) = 'TestType'
    LocalVarOutStrings(80) = 'Kp_Float'
    LocalVarOutStrings(81) = 'VS_MaxTq'
    LocalVarOutStrings(82) = 'VS_LastGenTrq'
    LocalVarOutStrings(83) = 'VS_LastGenPwr'
    LocalVarOutStrings(84) = 'VS_MechGenPwr'
    LocalVarOutStrings(85) = 'VS_SpdErrAr'
    LocalVarOutStrings(86) = 'VS_SpdErrBr'
    LocalVarOutStrings(87) = 'VS_SpdErr'
    LocalVarOutStrings(88) = 'VS_State'
    LocalVarOutStrings(89) = 'VS_Rgn3Pitch'
    LocalVarOutStrings(90) = 'WE_Vw'
    LocalVarOutStrings(91) = 'WE_Vw_F'
    LocalVarOutStrings(92) = 'WE_VwI'
    LocalVarOutStrings(93) = 'WE_VwIdot'
    LocalVarOutStrings(94) = 'WE_Op'
    LocalVarOutStrings(95) = 'WE_Op_Last'
    LocalVarOutStrings(96) = 'VS_LastGenTrqF'
    LocalVarOutStrings(97) = 'PRC_WSE_F'
    LocalVarOutStrings(98) = 'PRC_R_Speed'
    LocalVarOutStrings(99) = 'PRC_R_Torque'
    LocalVarOutStrings(100) = 'PRC_R_Pitch'
    LocalVarOutStrings(101) = 'PRC_R_Total'
    LocalVarOutStrings(102) = 'PRC_Min_Pitch'
    ...
    LocalVarOutStrings(137) = 'TipDxc1'
    LocalVarOutStrings(138) = 'TipDxc2'
    LocalVarOutStrings(139) = 'TipDxc3'
    LocalVarOutStrings(140) = 'TipDxcCol_1P'
    LocalVarOutStrings(141) = 'TipDxcTilt_1P'
    LocalVarOutStrings(142) = 'TipDxcYaw_1P'
    LocalVarOutStrings(143) = 'TipDxcColF_1P'
    LocalVarOutStrings(144) = 'TipDxcTiltF_1P'
    LocalVarOutStrings(145) = 'TipDxcYawF_1P'
    LocalVarOutStrings(146) = 'TipDxcTiltRef_1P'
    LocalVarOutStrings(147) = 'CC_DesiredL'
    LocalVarOutStrings(148) = 'CC_ActuatedL'
    LocalVarOutStrings(149) = 'CC_ActuatedDL'
    LocalVarOutStrings(150) = 'StC_Input'
    LocalVarOutStrings(151) = 'Flp_Angle'
    LocalVarOutStrings(152) = 'RootMyb_Last'
    LocalVarOutStrings(153) = 'ACC_INFILE_SIZE'
    LocalVarOutStrings(154) = 'AWC_complexangle'
    LocalVarOutStrings(155) = 'ZMQ_ID'
    LocalVarOutStrings(156) = 'ZMQ_YawOffset'
    LocalVarOutStrings(157) = 'ZMQ_TorqueOffset'
    LocalVarOutStrings(158) = 'ZMQ_PitOffset'
    LocalVarOutStrings(159) = 'ZMQ_R_Speed'
    LocalVarOutStrings(160) = 'ZMQ_R_Torque'
    LocalVarOutStrings(161) = 'ZMQ_R_Pitch'
    ...
    IF ((LocalVar%iStatus == 0) .OR. (LocalVar%iStatus == -9))  THEN ! .TRUE. if we're on the first call to the DLL
        ...
        IF (CntrPar%LoggingLevel > 1) THEN
            ...
            WRITE(UnDb2, '(162(a20,TR5:))') 'Time',   LocalVarOutStrings
            WRITE(UnDb2, '(162(a20,TR5:))')
        END IF
    ...
    ! Write debug files
    FmtDat = "(F20.5,TR5,161(ES20.5E2,TR5:))"   ! The format of the debugging data
