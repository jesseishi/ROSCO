...
SUBROUTINE WriteRestartFile(LocalVar, CntrPar, ErrVar, objInst, RootName, size_avcOUTNAME)
    ...
    ELSE
        ...
        WRITE( Un, IOSTAT=ErrStat) LocalVar%TCIPC_AzimuthOffset
...
SUBROUTINE ReadRestartFile(avrSWAP, LocalVar, CntrPar, objInst, PerfData, RootName, size_avcOUTNAME, ErrVar)
    ...
    ELSE
        ...
        READ( Un, IOSTAT=ErrStat) LocalVar%TCIPC_AzimuthOffset
...
! Debug routine, defines what gets printed to DEBUG.dbg if LoggingLevel = 1
    ...
    CHARACTER(15), DIMENSION(162)      :: LocalVarOutStrings
    ...
    LocalVarOutData(147) = LocalVar%TCIPC_AzimuthOffset
    ...
    LocalVarOutData(156) = LocalVar%ZMQ_ID
    LocalVarOutData(157) = LocalVar%ZMQ_YawOffset
    LocalVarOutData(158) = LocalVar%ZMQ_TorqueOffset
    LocalVarOutData(159) = LocalVar%ZMQ_PitOffset(1)
    LocalVarOutData(160) = LocalVar%ZMQ_R_Speed
    LocalVarOutData(161) = LocalVar%ZMQ_R_Torque
    LocalVarOutData(162) = LocalVar%ZMQ_R_Pitch
    ...
    LocalVarOutStrings(147) = 'TCIPC_AzimuthOffset'
    ...
    LocalVarOutStrings(156) = 'ZMQ_ID'
    LocalVarOutStrings(157) = 'ZMQ_YawOffset'
    LocalVarOutStrings(158) = 'ZMQ_TorqueOffset'
    LocalVarOutStrings(159) = 'ZMQ_PitOffset'
    LocalVarOutStrings(160) = 'ZMQ_R_Speed'
    LocalVarOutStrings(161) = 'ZMQ_R_Torque'
    LocalVarOutStrings(162) = 'ZMQ_R_Pitch'
    ...
    IF ((LocalVar%iStatus == 0) .OR. (LocalVar%iStatus == -9))  THEN ! .TRUE. if we're on the first call to the DLL
        ...
        IF (CntrPar%LoggingLevel > 1) THEN
            ...
            WRITE(UnDb2, '(163(a20,TR5:))') 'Time',   LocalVarOutStrings
            WRITE(UnDb2, '(163(a20,TR5:))')
        END IF
    ...
    ! Write debug files
    FmtDat = "(F20.5,TR5,162(ES20.5E2,TR5:))"   ! The format of the debugging data
