...
def write_roscoio(yfile):
    ...
    file.write("            END DO\n")
    file.write("\n")
    file.write("        ! Extended signal inputs\n")
    file.write("        IF (CntrPar%Ext_Interface > 0) THEN \n")
    file.write("            DO Ind = 1001, 1018\n")
    file.write("                Call AddToList(avrIndices, Ind)\n")
    file.write("            END DO\n")
    file.write("\n")
    file.write("            DO Ind = 1020, 1022\n")
    file.write("                Call AddToList(avrIndices, Ind)\n")
    file.write("            END DO\n")
    file.write("        ENDIF\n")
    file.write("\n")
