...
SUBROUTINE WriteRestartFile(LocalVar, CntrPar, ErrVar, objInst, RootName, size_avcOUTNAME)
    ...
    ELSE
        ...
        WRITE( Un, IOSTAT=ErrStat) LocalVar%IPCTip_AxisYaw_1P
...
SUBROUTINE ReadRestartFile(avrSWAP, LocalVar, CntrPar, objInst, PerfData, RootName, size_avcOUTNAME, ErrVar)
    ...
    ELSE
        ...
        READ( Un, IOSTAT=ErrStat) LocalVar%IPCTip_AxisYaw_1P
...
! Debug routine, defines what gets printed to DEBUG.dbg if LoggingLevel = 1
    ...
    LocalVarOutData(61) = LocalVar%IPCTip_AxisYaw_1P
    ...
    LocalVarOutData(138) = LocalVar%TipDxc1
    LocalVarOutData(139) = LocalVar%TipDxc2
    LocalVarOutData(140) = LocalVar%TipDxc3
    LocalVarOutData(141) = LocalVar%TipDxcCol_1P
    LocalVarOutData(142) = LocalVar%TipDxcTilt_1P
    LocalVarOutData(143) = LocalVar%TipDxcYaw_1P
    LocalVarOutData(144) = LocalVar%TipDxcColF_1P
    LocalVarOutData(145) = LocalVar%TipDxcTiltF_1P
    LocalVarOutData(146) = LocalVar%TipDxcYawF_1P
    LocalVarOutData(147) = LocalVar%TipDxcTiltRef_1P
    LocalVarOutData(148) = LocalVar%TCIPC_AzimuthOffset
    LocalVarOutData(149) = LocalVar%CC_DesiredL(1)
    LocalVarOutData(150) = LocalVar%CC_ActuatedL(1)
    LocalVarOutData(151) = LocalVar%CC_ActuatedDL(1)
    LocalVarOutData(152) = LocalVar%StC_Input(1)
    LocalVarOutData(153) = LocalVar%Flp_Angle(1)
    LocalVarOutData(154) = LocalVar%RootMyb_Last(1)
    LocalVarOutData(155) = LocalVar%ACC_INFILE_SIZE
    LocalVarOutData(156) = LocalVar%AWC_complexangle(1)
    LocalVarOutData(157) = LocalVar%ZMQ_ID
    LocalVarOutData(158) = LocalVar%ZMQ_YawOffset
    LocalVarOutData(159) = LocalVar%ZMQ_TorqueOffset
    LocalVarOutData(160) = LocalVar%ZMQ_PitOffset(1)
    LocalVarOutData(161) = LocalVar%ZMQ_R_Speed
    LocalVarOutData(162) = LocalVar%ZMQ_R_Torque
    LocalVarOutData(163) = LocalVar%ZMQ_R_Pitch
    ...
    LocalVarOutStrings(61) = 'IPCTip_AxisYaw_1P'
    ...
    LocalVarOutStrings(138) = 'TipDxc1'
    LocalVarOutStrings(139) = 'TipDxc2'
    LocalVarOutStrings(140) = 'TipDxc3'
    LocalVarOutStrings(141) = 'TipDxcCol_1P'
    LocalVarOutStrings(142) = 'TipDxcTilt_1P'
    LocalVarOutStrings(143) = 'TipDxcYaw_1P'
    LocalVarOutStrings(144) = 'TipDxcColF_1P'
    LocalVarOutStrings(145) = 'TipDxcTiltF_1P'
    LocalVarOutStrings(146) = 'TipDxcYawF_1P'
    LocalVarOutStrings(147) = 'TipDxcTiltRef_1P'
    LocalVarOutStrings(148) = 'TCIPC_AzimuthOffset'
    LocalVarOutStrings(149) = 'CC_DesiredL'
    LocalVarOutStrings(150) = 'CC_ActuatedL'
    LocalVarOutStrings(151) = 'CC_ActuatedDL'
    LocalVarOutStrings(152) = 'StC_Input'
    LocalVarOutStrings(153) = 'Flp_Angle'
    LocalVarOutStrings(154) = 'RootMyb_Last'
    LocalVarOutStrings(155) = 'ACC_INFILE_SIZE'
    LocalVarOutStrings(156) = 'AWC_complexangle'
    LocalVarOutStrings(157) = 'ZMQ_ID'
    LocalVarOutStrings(158) = 'ZMQ_YawOffset'
    LocalVarOutStrings(159) = 'ZMQ_TorqueOffset'
    LocalVarOutStrings(160) = 'ZMQ_PitOffset'
    LocalVarOutStrings(161) = 'ZMQ_R_Speed'
    LocalVarOutStrings(162) = 'ZMQ_R_Torque'
    LocalVarOutStrings(163) = 'ZMQ_R_Pitch'
    ...
    IF ((LocalVar%iStatus == 0) .OR. (LocalVar%iStatus == -9))  THEN ! .TRUE. if we're on the first call to the DLL
        ...
        IF (CntrPar%LoggingLevel > 1) THEN
            ...
            WRITE(UnDb2, '(164(a20,TR5:))') 'Time',   LocalVarOutStrings
            WRITE(UnDb2, '(164(a20,TR5:))')
        END IF
    ...
    ! Write debug files
    FmtDat = "(F20.5,TR5,163(ES20.5E2,TR5:))"   ! The format of the debugging data
