...
! -----------------------------------------------------------------------------------
    ...
    SUBROUTINE ReadControlParameterFileSub(CntrPar, LocalVar, accINFILE, accINFILE_size, RootName, ErrVar)!, accINFILE_size)
        ...
        CALL ParseInput(FileLines,'TCIPC_ControlMode',      CntrPar%TCIPC_ControlMode,        accINFILE(1), ErrVar, UnEc=UnEc)
        ...
        CALL ParseAry(  FileLines,  'TCIPC_GS_IntegratorGains', CntrPar%TCIPC_GS_IntegratorGains, CntrPar%TCIPC_GS_n, accINFILE(1), ErrVar, CntrPar%TCIPC_ControlMode == 0, UnEc)
