...
def write_DISCON(turbine, controller, param_file='DISCON.IN', txt_filename='Cp_Ct_Cq.txt', rosco_vt = {}):
    ...
    file.write('{0:<12d}        ! TCIPC_ControlMode      - Turn Tower Clearance Individual Pitch Control (TCIPC) for tower clearance {{0: off, 1: on}}\n'.format(int(rosco_vt['TCIPC_ControlMode'])))
