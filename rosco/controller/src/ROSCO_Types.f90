...
TYPE, PUBLIC :: LocalVariables
    ...
    REAL(DbKi)                    :: IPCTip_AxisTilt_1P          ! Integral of the tilt axis for tip deflection, 1P
    REAL(DbKi)                    :: IPCTip_AxisYaw_1P           ! Integral of the yaw axis for tip deflection, 1P
    ...
    REAL(DbKi)                    :: TipDxc2                     ! Tip deflection in the x-direction of blade 2 (m)
    REAL(DbKi)                    :: TipDxc3                     ! Tip deflection in the x-direction of blade 3 (m)
    REAL(DbKi)                    :: TipDxcCol_1P                ! Tip deflection in the collective-direction, 1P (m)
    REAL(DbKi)                    :: TipDxcTilt_1P               ! Tip deflection in the tilt-direction, 1P (m)
    REAL(DbKi)                    :: TipDxcYaw_1P                ! Tip deflection in the yaw-direction, 1P (m)
    REAL(DbKi)                    :: TipDxcColF_1P               ! Tip deflection in the collective-direction, 1P (m)
    REAL(DbKi)                    :: TipDxcTiltF_1P              ! Filtered tip deflection in the tilt-direction, 1P (m)
    REAL(DbKi)                    :: TipDxcYawF_1P               ! Filtered tip deflection in the yaw-direction, 1P (m)
    REAL(DbKi)                    :: TipDxcTiltRef_1P            ! Reference tip deflection in the tilt-direction, 1P (m)
    REAL(DbKi)                    :: TCIPC_AzimuthOffset         ! Azimuth offset used in the MBC transformation for tower clearance control that is interpolated from a lookup table (m)
